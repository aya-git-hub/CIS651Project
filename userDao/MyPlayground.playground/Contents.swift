...
class DatabaseManager {
    ...
    func openDatabase() -> OpaquePointer? {
        ...
        let fileURL = try! FileManager.default
            .url(for: .documentDirectory,
                 ...
                 appropriateFor: nil,
                 create: false)
            .appendingPathComponent("../database/UserDatabase.sqlite")
    ...
    func queryRecords(_ tableName: String, _ condition: String? = nil) -> [[String: Any]] {
    ...
    print(DB.queryRecords("Musics", "Author = pengfei"))
